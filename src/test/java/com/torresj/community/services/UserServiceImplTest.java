...
import static com.torresj.community.enums.UserRole.USER_ROLE;
...
class UserServiceImplTest {
    ...
    void givenUser_WhenCreateUser_ThenUserIsCreated() throws CommunityNotFoundException {
        ...
        UserDto userDto = new UserDto(1, communityDto, "create_test", USER_ROLE);
        ...
        UserDto user = userService.create(1L, "create_test", "test", USER_ROLE);
    ...
    void givenUser_WhenCreateUserWithoutCommunity_ThenUserIsCreated()
        ...
        UserEntity userEntity =
                UserEntity.builder()
                        ...
                        .communityId(null)
                        .build();
        UserDto userDto = new UserDto(1, null, "create_test", USER_ROLE);
        when(userRepository.save(any())).thenReturn(userEntity);
        when(userMapper.toUserDto(userEntity, null)).thenReturn(userDto);

        UserDto user = userService.create(null, "create_test", "test", USER_ROLE);
    ...
    void givenUser_WhenCreateUserWithCommunityIdIncorrect_ThenExceptionIsThrown()
        ...
        CommunityNotFoundException exception =
                assertThrows(
                        ...
                        () -> userService.create(1L, "create_test", "test", USER_ROLE));
    ...
    void givenUserId_WhenGetUserById_ThenUserIsReturned()
        ...
        UserEntity userEntity =
                UserEntity.builder()
                        ...
                        .communityId(1L)
                        .build();
        UserDto userDto = new UserDto(1L, communityDto, "get_test", USER_ROLE);
        when(communityService.get(1L)).thenReturn(communityDto);
        ...
        List<UserEntity> entities =
                List.of(
                        ...
                        UserEntity.builder()
                                ...
                                .communityId(1L)
                                .build());
        UserDto userDto1 = new UserDto(1L, communityDto, "get_test", USER_ROLE);
        UserDto userDto2 = new UserDto(2L, communityDto, "get_test2", USER_ROLE);
        when(communityService.get(1L)).thenReturn(communityDto);
    ...
    void givenNonExistentUserId_WhenUpdateRole_ThenExceptionIsThrown() {
        ...
        UserNotFoundException exception = assertThrows(
                UserNotFoundException.class,
                () -> userService.update(999L, UserRole.ADMIN_ROLE)
        );
